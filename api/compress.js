...
const CONFIG = {
    ...
    localQuality: Number(process.env.LOCAL_QUALITY) || 35, // 🔥 Calidad 25% para compresión rápida
    localQualityHigh: Number(process.env.LOCAL_QUALITY_HIGH) || 30,
    localQualityMin: Number(process.env.LOCAL_QUALITY_MIN) || 25,
